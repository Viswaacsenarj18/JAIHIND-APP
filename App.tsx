...
import AdminHistoryPage from "./src/screens/admin/AdminHistoryPage";
import AdminAnalysisPage from "./src/screens/admin/AdminAnalysisPage";
...
const AdminPanel = ({ navigation }: any) => {
  ...
  const renderPage = () => {
    switch (activeTab) {
      ...
      case "Analysis": return <AdminAnalysisPage />;
